...
public class Constants {
  ...
  public static final String COLLECTION_NAME = "Reisepass";
  public static final String CONFIGURATION_NAME = "helpgv_config";
  public static final String CLUSTER_NAME = "HelpGV";
  public static final String RANKER_NAME = "ranker-reisepass";
